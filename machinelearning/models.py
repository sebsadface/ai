    ...
    def train(self, dataset):
        ...
        while True:
            for x, y in dataset.iterate_forever(self.batch_size):
                ...
                self.W1.update(gradients[0], -self.lr)
                self.b1.update(gradients[1], -self.lr)
                self.W2.update(gradients[2], -self.lr)
                self.b2.update(gradients[3], -self.lr)
...
class LanguageIDModel(object):
    ...
    def __init__(self):
        ...
        self.W3 = nn.Parameter(self.hidden_size, len(self.languages))
    ...
    def train(self, dataset):
        ...
        while True:
            for xs, y in dataset.iterate_forever(self.batch_size):
                ...
                gradients = nn.gradients(loss, [self.W1, self.b1, self.W2, self.W3, self.b3])
                ...
                self.W3.update(gradients[3], -self.learning_rate)
                self.b3.update(gradients[4], -self.learning_rate)

                validation_accuracy = dataset.get_validation_accuracy()
                if validation_accuracy >= 0.89:
                    return
